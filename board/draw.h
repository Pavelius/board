...
int						getresult();
int						getwidth();
void					glyph(int x, int y, int sym, unsigned flags, unsigned char alpha = 0xFF);
...
void					sysredraw();
void					text(int x, int y, const char* string, int count = -1, unsigned flags = 0, unsigned char alpha = 0xFF);
int						text(rect rc, const char* string, unsigned state = 0, int* max_width = 0, unsigned char alpha = 0xFF);
